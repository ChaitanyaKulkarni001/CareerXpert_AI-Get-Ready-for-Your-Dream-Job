...
const SituationalQuestions = () => {
  ...
  //   THE AUDIO RECORDER ONSUBMIT FUNCTION HERE
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("AdditionalInfo", "I am a " + profession + " with " + experienceLevel + " experience of " + yearsOfExperience + " years. I am looking for a job in " + companyName + ".Extra Info is " + additionalInfo);
  ...
  return (
    <div className="max-w-xl mx-auto mt-10 p-4">
      ...
      >
        {isFormOpen ? 'Close Interview Form' : 'Open Interview Form'}
      </button> */}

      {isFormOpen && (
        <form
          onSubmit={handleSubmit}
          className="mt-4 space-y-6 bg-white p-8 rounded-2xl shadow-lg border border-gray-100 transform transition-all duration-300 ease-in-out hover:shadow-xl"
        >
          {/* Profession Field */}
          <div>
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">Is this for a specific company?</label>
      ...
      {question && (
        ...
        <div className="mt-6 p-4 bg-gray-100 rounded-lg shadow-sm">
          ...
          <div className="follow-up-interview-container max-w-3xl mx-auto mt-10 p-6 border rounded-lg shadow-lg bg-gray-50">
            {/* <h1 className="text-3xl font-bold text-center mb-6">Follow-Up Interview</h1> */}
