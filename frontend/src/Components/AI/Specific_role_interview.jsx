...
const SpecificRoleInterview = () => {
  ...
  return (
    <div className="max-w-xl mx-auto mt-10 p-4 border bg-white">
      {/* Title */}
      ...
      {question && (
        ...
        <div className="mt-6 p-4 bg-gray-100 rounded-lg shadow-sm">
          ...
          <div className="follow-up-interview-container max-w-3xl mx-auto mt-2 p-6 border rounded-lg shadow-lg bg-gray-50">
