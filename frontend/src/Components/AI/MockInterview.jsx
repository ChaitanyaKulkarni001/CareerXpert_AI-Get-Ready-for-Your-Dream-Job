...
const MockInterview = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="flex md:flex-row bg-white shadow-lg rounded-lg p-8 mb-6">
        {/* Left Side: Info & Button */}
        <div className="w-full md:w-1/2 flex flex-col justify-center items-start text-left p-6 bg-white shadow-lg rounded-lg border border-gray-200">
      ...
      <div className="bg-white shadow-lg rounded-lg p-8">
        <h2 className="text-2xl font-bold text-black-600 mb-6 text-center">Previous Interviews</h2>
